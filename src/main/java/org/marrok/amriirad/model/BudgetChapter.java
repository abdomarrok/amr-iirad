...
public class BudgetChapter {
    ...
    public void setLabelAr(String l)        { this.labelAr = l; }

    public String getLabelFr()              { return labelFr; }
    public void setLabelFr(String l)        { this.labelFr = l; }

    public Integer getParentId()            { return parentId; }
    public void setParentId(Integer p)      { this.parentId = p; }
    ...
    @Override
    public String toString() { return code + " — " + labelAr; }
}
